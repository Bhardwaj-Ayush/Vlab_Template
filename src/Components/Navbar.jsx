...
export default function Navbar() {
  return (
    <>
                <nav className="sticky top-0 z-10 p-2 h-48 lg:h-28 sm:space-x-8">
                        <div className="text-center text-base  bg-opacity-80">
                            <Link className="internal_link" to="./Aim">
                                <img className=" lg:h-14 lg:w-14  h-8 w-8 rounded mt-2 mx-4"
                        ...
                        <div className=" text-center text-base">
                            <Link className="internal_link" to="./Theory">
                                <img className="lg:h-14 lg:w-14 h-8 w-10 rounded mt-2 mx-2 " src="https://cdn-icons-png.flaticon.com/512/1648/1648697.png"alt='/'/>
