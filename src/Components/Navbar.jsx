...
export default function Navbar() {
  return (
    <>
                <nav className="sticky top-0 z-10 p-2 h-100 md:h-48 lg:h-36">
                        <div className="boxq border-2 border-white rounded-md text-center text-base mx-2 bg-opacity-80">
                            <Link className="internal_link" to="./Aim">
                                <img className="lg:h-14 lg:w-14 h-10 w-10 rounded-full mt-2 mx-4 " src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBmpbB3jSjMF-FDgIL1E-eRN6eeCDLSsvoAQ&usqp=CAU"alt='/'/>
                                <span className='text-sm lg:text-lg md:text-lg'>Aim</span></Link>
                        </div>
                        <div className="boxq border-2 border-white rounded-md text-center text-base mx-4 bg-opacity-80">
                        ...
                        <div className="boxq border-2 border-white rounded-md text-center text-base mx-2">
                        ...
                        <div className="boxq border-2 border-white rounded-md text-center text-base mx-2">
                            <Link className="internal_link" to="./Team">
                                <img className="md:h-14 lg:h-14 lg:w-14 h-8 w-10 rounded-full mt-2 mx-4" 
                                src="https://image.pngaaa.com/134/5592134-middle.png"alt='/'/>
                                <span className='text-sm lg:text-lg md:text-lg'>Team</span></Link>
                        </div>
                </nav>
    </>
  )
